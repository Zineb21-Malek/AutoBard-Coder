# APEX — Formula 1 race data website

A small Flask site powered by **FastF1** for the season calendar, next race, and race classifications, plus championship standings from Jolpica (Ergast-compatible).
